    ...
    def get_daily_price(self, code, start_date=None, end_date=None):
        ...
        if(start_date is None):
            ...
            if start_month < 1 or start_month > 12:
                print(f"VlueError: start_month({start_month:d}) is wrong.")
                return
            if start_day < 1 or start_day > 31:
                print(f"VlueError: start_day({start_day:d}) is wrong.")
                return
        ...
        sql = f"SELECT * FROM tb_daily_price WHERE code = '{code}' and date >= '{start_date}' and date <= '{end_date}'"
